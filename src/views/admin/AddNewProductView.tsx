...
export default function AddNewProductView() {
  ...
  const validateInput = (values: any) => {
    ...
    if (!values.variants[0].type && !values.variants[1].type && !values.variants[2].type) errors.variants = "Setidaknya satu varian harus diisi";
        ...
        <div className="w-full">
          ...
          <div className="p-14">
            <Formik
              ...
              }} onSubmit={(values) => { console.log(values) }} validate={validateInput}>
              <Form className="flex flex-col gap-4">
                ...
                <div className="flex flex-col grid grid-cols-1 md:grid-cols-3 gap-10 w-full mb-4">
                  <div className="p-2 flex flex-col gap-1">
                    ...
                    <div className='flex justify-center aspect-[6/9] border-4 border-tetriary-400 lg:mx-14'>
                      <img src={sixByNineRef.current} className='text-center' alt='Pilih Foto' />
                    </div>
                    <div className='grow' />
                  ...
                  <div className="p-2 flex flex-col gap-1">
                    ...
                    <div className='flex justify-center aspect-[1/1] border-4 border-tetriary-400'>
                      <img src={oneByOneRef.current} className='text-center' alt='Pilih Foto' />
                    </div>
                    <div className='grow' />
                  ...
                  <div className="p-2 flex flex-col gap-1">
                    ...
                    <div className='flex justify-center aspect-[5/6] border-4 border-tetriary-400'>
                      <img src={fiveBySixRef.current} className='text-center' alt='Pilih Foto' />
                    </div>
                    <div className='grow' />
                ...
                <ErrorMessage name="variants" component="div" className="text-red-500" />
